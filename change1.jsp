...
<html>
    ...
    try{
    if(usertype=="Farmer"){
        st.executeUpdate("update farmer set Address='"+address+"' , State='"+state+"' where uname='" +username+ "'");
        response.sendRedirect("setting.jsp");
    }
    else{
        st.executeUpdate("update buyer set Address='"+address+"' , State='"+state+"' where username='" +username+ "'");
        response.sendRedirect("setting.jsp");
    }
    }
