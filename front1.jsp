  ...
  <div id="myCarousel" class="carousel slide" data-ride="carousel">
	...
	<div class="container">
      ...
      <%
        ...
        {
      %>
          <a href="buyfarmer.jsp" class="thumbnail">
             <img src="image/Buyer.jpg" style="width: 169px;" alt="responsive image" class="image img-responsive">
             <div class="caption">
                <center>
                   <h3>BUYING CROPS</h3>
                </center>
      ...
      %>
          <a href="buybuyer.jsp" class="thumbnail">
             <img src="image/Buyer.jpg" style="width: 169px;" alt="responsive image" class="image img-responsive">
             <div class="caption">
                <center>
      ...
      <% } %>
			...
			<div class="col-md-3 col-sm-6">
				<a href="crop.jsp" class="thumbnail"><img src="image/Crop.jpg" style="width: 296px;" alt="responsive image" class="image img-responsive">
					<div class="caption">
						<center>
							<h3>CROP DETAILS</h3>
						</center>
